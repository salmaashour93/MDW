...
class AllDaysViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, AgendaViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.refreshController.addTarget(self, action: #selector(AllDaysViewController.didRefreshList), forControlEvents: .ValueChanged)
    }
