...
class SecondDayViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, AgendaViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.refreshController.addTarget(self, action: #selector(SecondDayViewController.didRefreshList), forControlEvents: .ValueChanged)
    }
